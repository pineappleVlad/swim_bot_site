...
from handlers.callback import view_stats, view_balance, back_button_callback, training_booking, booking_info_confirm, booking_accept, booking_cancel_choose, booking_cancel_info, booking_cancel_confirm, current_child_save, balance_update, add_trainings_to_balance
