...
from .views import home_page, closed_trainings_page, add_training, delete_training, update_training_status, edit_training, add_trainer, \
    add_child, update_balance, trainer_delete, child_delete, balance_operations, delete_balance_operation, \
    clear_balance_history, update_child_info, update_trainer_info, add_child_list, password_block, delete_inactive_childs, duplicate_training, close_expired_trainings
...
urlpatterns = [
    ...
    path('closed_trainings/', closed_trainings_page, name='closed_trainings'),
    ...
    path('close_expired_trainings', close_expired_trainings, name='close_expired_trainings')
]